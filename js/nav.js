...
Nav.prototype.makeHelpGuide = function() {
  let  helpGuide = document.createElement('div');
  helpGuide.setAttribute('id', 'helpGuide');
  helpGuide.textContent = '?';
  helpGuide.classList.add('navlink');
  helpGuide.classList.add('navlink-question-mark');

  document.getElementById('topbar').appendChild(helpGuide);

  const helpGuideModal ='<h1>Welcome to Global.health Map!</h1> \
